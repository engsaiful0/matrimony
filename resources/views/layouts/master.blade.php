...
<head>
	...
	<meta name="description" content="Matrimony App">
	<meta name="keywords" content="Matrimony app">
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="header-left">
                	<a href="{{ route('home') }}" class="logo"> <img src="{{asset('images/matrimony_logo.jpg')}}" style="width: 100%; height: 55px;border-radius: 10px"  alt=""> </a>
